...
-- WARNING: This will delete ALL user data, organizations, and audit logs
...
-- 3. Clear users (may be referenced by other tables)
DELETE FROM users;

-- 4. Clear organizations (may be referenced by other tables)
